...
echo "My Browser Language is:" . $browserlang = substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2). "<br>";
 if ($browserlang == "en"){
	echo $lang = "en";
	
 }elseif ($browserlang == "ar"){
	echo $lang = "ar";	
 }
...
/*					    echo  "userstored lang:" . Auth::user()->lang;					
	...
	<?php } ?>
        ...
        <div class="container-fluid my-5">
            <div dir="" class="row">
			<?php if (substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) == "ar"){?>
			...
			<?php } ?>
					...
					<?php 	
								if (substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) == "ar"){ ?>
			...
			<?php } ?>         
			<a href="{{ url('/register') }}" class="btn pr-3 pl-3 pb-2" style="background-color: #0174CF; color: white; border-radius: 50px;" >
			<?php if (substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) == "ar"){?>
            	سجل الان
			<?php	}elseif (substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) == "en"){ ?>
			Register Now
		...
		?>
			...
			<?php foreach ($appointments as $appointment)
					{ ?>
                        ...
                        <tr>
                            <td class="align-middle"><a href="showcalender?appid=<?=$appointment->id?>" target="_new" class="btn bg-white shadow px-3 text-blue w-75">
							<?php if (substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) == "ar"){?>
            ...
            <div class="container pb-5 mb-5">
                <div class="row my-sm-5 pb-sm-5">
				  ...
				  <?php if (Auth::user()->role != "admin") { ?>
									...
									<?php if (!$students1) { ?>
						<a  class="btn w-50 pb-2" href="students/create" style="background-color: white; color: #0174CF; border-radius: 30px; font-size: large;">اشترك الأن</a>
											<?php }else{?>
						<a  class="btn w-50 pb-2"  style="background-color: white; color: #0174CF; border-radius: 30px; font-size: large;" href="subscriptions_insert?subid=<?= $bouquet->id;?>">اشترك الأن</a>
											<?php } ?>
											 <?php  } else { ?>
        ...
        <div class="container text-center mb-5 text-blue" id="contact" >
            ...
            <div class="row m-auto border overflow-hidden shadow bg-blue text-white" style=" border-radius: 40px;">
                <div class="col-12 col-lg-6 text-right p-5 my-auto" style="font-size: x-large; line-height: 2.5;">
                    <a href="#" style="color: white; text-decoration: none;"><i class="fas fa-map-marker-alt" style="padding-left: 1.3rem; padding-right: 1.3rem;"></i> العنوان </a> <br>
                    <a href="mailto:someone@example.com" style="color: white; text-decoration: none;"><i class="fas fa-envelope px-3"></i> بريد الشركة </a> <br> 
                    <a href="tel:+201141133812" style="color: white; text-decoration: none;"><i class="fas fa-phone-alt px-3"></i> تليفون الشركة </a> <br>
