...
<html lang="ar" dir="rtl">
 ...
 <input id="payid"  type="hidden" value="<?=$_GET['payid']?>" name="payid"  >
        ...
        <div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;"> تعديل طريقة الدفع</span></h1>
			...
			?>                       
					   <div class="row">                            
                            <div class="col-9 col-md-10 text-light my-auto px-sm-5 text-right " >
									...
									<div class="row">
                                        <div class="col-sm-4 py-2 pr-5" style="font-size: x-large;"> تفعيل الباقة  </div>
                                        <div class="col-sm-8 m-auto py-2">
										<select id="active"  name="active" class="form-control w-75 m-auto">
										<option value="2">تفعيل</option>
										<option value="1">عدم تفعيل</option>
										</select>
