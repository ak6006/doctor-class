							...
							<table id='table-draggable1' class="table table-striped table-bordered mx-auto shadow w-100 text-center" >
								<thead class="bg-white text-blue" style="font-size: larger;">
									<tr>
										...
										<th class="align-middle" style="min-width: 350px;">اسم الفرع</th>  
										<th class="align-middle" style="min-width: 350px;">تاريخ الإنتهاء </th> 
										<th class="align-middle" style="min-width: 20px;">الترتيب</th>  
									</tr>
								</thead>  
								<tbody class="connectedSortable">  
									<tr>   
										...
										<td class="align-middle text-right">
											الشركه العالمية <span class="bg-warning rounded-lg px-2 mx-2">Work</span>
										</td>  
                                                                <td></td>
