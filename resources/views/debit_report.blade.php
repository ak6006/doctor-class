...
<html>
    ...
    <body >
        <div class="container bootstrap snippet">
			...
			<div class="row">
			<h3 class="m-auto">عمليات السحب</h3>		
				<div class="col-12 ">
					<div class="tabbable" > 
							...
							<table id='table-draggable1' class="table table-striped table-bordered mx-auto shadow w-100 text-center" >
								<thead class="bg-white text-blue" style="font-size: larger;">
									<tr>
										...
										<th class="align-middle" style="min-width: 150px;">رقم الباقة</th> 
										
									</tr>
								</thead>  
								<tbody class="connectedSortable">  
								     <?php    $wallets = DB::table('money_wallet')->orderBy('id', 'desc')->where('companyid', $_GET['coid'])->where('cancel', 0)->where('boqauet_cridet', '!=', '0')->get();
