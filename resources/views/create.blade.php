...
<html lang="ar" dir="rtl">
    ...
    <body class="bg-light">
        ...
        <div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;"> Register A New Company</span></h1>
                            ...
                            <div class="col-9 col-md-10 text-light my-auto px-sm-5 text-left " >
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 m-auto py-2 "><input type="text" id="name" name="name" class="form-control w-75 m-auto" required></div>
                                    </div>
								<div class="row">
                                ...
                                <?php      
									...
									<select  class="form-control w-75 m-auto" required dir="ltr" id="city"  name="city" required>
							        ...
							        <div class="row">
                                        ...
                                        <div class="col-sm-8 m-auto py-2 "><input type="text" id="address"  name="address" class="form-control w-75 m-auto" required></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4 py-2 pr-5" style="font-size: x-large;"> Phone Number </div>
                                        <div class="col-sm-8 m-auto py-2 "><input type="number"  id="phone"  name="phone" class="form-control w-75 m-auto" required></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-sm-4 py-2 pr-5" style="font-size: x-large;">  VAT ID </div>
                                        <div class="col-sm-8 m-auto py-2 "><input type="text" class="form-control w-75 m-auto" id="vat"  name="vat" ></div>
                                    </div>
                                    <div class="row">
		...
		<?php }elseif ($langg == "ar") { ?>
		<div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;">تسجيل شركة</span></h1>
            <div class="container-md container-fluid mt-3 mb-5">
                <div class="row">
                    <div class="col-md-1"></div>
