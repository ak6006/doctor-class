...
<?php //$title = 'register'; ?>
        ...
        <div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;">تعديل بياناتى</span></h1>
                    ...
                    <div class="col-12 col-md-10 shadow overflow-hidden" style="background-color: #0174CF; border-radius: 30px;">
                        <div class="row">
                            ...
                            <div class="col-9 col-md-10 text-light my-auto px-sm-5 text-right " >
                                <form method="GET" action="{{ url('useredited') }}" enctype="multipart/form-data">
								@csrf
                                    <div class="row mt-5">
                                        <div class="col-sm-4 py-2 pr-5" style="font-size: x-large;"> اسم المستخدم </div>
                                        <div class="col-sm-8 m-auto py-2 ">
										<input id="name"  type="text"  name="name" value="{{ Auth::user()->name }}"  autocomplete="name"  class="form-control w-75 m-auto @error('name') is-invalid @enderror rounded-0" required>
										</div>
								@error('name')
								...
								@enderror
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 m-auto py-2 ">
										<input id="email" type="email" class="form-control w-75 m-auto @error('email') is-invalid @enderror rounded-0" name="email" value="{{ Auth::user()->email }}" required autocomplete="email" >
										</div>
								@error('email')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
								...
								@enderror
                                    ...
                                    <div class="row">
										...
										<div class="input-group-prepend ">
										  <span class="input-group-text  py-0" id="basic-addon1">+966</span>
										</div>
										<input id="mobile" type="number" class="form-control @error('mobile') is-invalid @enderror rounded-0" name="mobile" value="{{ Auth::user()->mobile }}" required autocomplete="mobile" >
									</div>
										</div>
								@error('mobile')
									<span class="invalid-feedback" role="alert">
								...
								@enderror
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-8 m-auto py-3">
                                            <div class="m-auto text-left" style="width: 75%;">
                                                <a href="{{ url('/usereditpassword') }}" class="btn pb-1 pt-0 px-4  text-white font-weight-bolder" style="border: 2px solid white; border-radius: 10px;" >تغيير كلمة السر </a>
                                            </div>
										</div>
                                    </div>
		...
		<?php }elseif ($langg == "en") { ?>
		        <div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;">Edit My Information</span></h1>
            <div class="container-md container-fluid mt-3 mb-5">
                <div class="row ">
                    <div class="col-md-1"></div>
                    <div class="col-12 col-md-10 pl-0 shadow overflow-hidden" style="background-color: #0174CF; border-radius: 30px;">
                        <div class="row">
                            <div class="col-3 col-md-2 pr-0 my-auto">
                                <a title="Edit my Information" href="">
                            ...
                            <div class="col-9 col-md-10 text-light my-auto px-sm-5 text-left " >
								...
								@enderror
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 py-2 pr-5" style="font-size: x-large;"> Email</div>
                                        <div class="col-sm-8 m-auto py-2 ">
										<input id="email" type="email" class="form-control w-75 m-auto @error('email') is-invalid @enderror rounded-0" name="email" value="{{ Auth::user()->email }}" required autocomplete="email" >
										</div>
								@error('email')
								...
								@enderror
									...
									<div class="row">
                                        ...
                                        <div class="col-sm-8 m-auto py-3">
                                            <div class="m-auto text-left" style="width: 75%;">
                                                <input class="btn  pb-2 pt-0 px-5" type="submit" value="Update" style="background-color: white; color: #0174CF; border-radius: 10px; font-size: x-large;">
                                            </div>
										</div>
                                    </div>
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-8 m-auto py-3">
                                            <div class="m-auto text-left" style="width: 75%;">
                                                <a href="{{ url('/usereditpassword') }}" class="btn pb-1 pt-0 px-4  text-white font-weight-bolder" style="border: 2px solid white; border-radius: 10px;" >Change Password</a>
                                            </div>
										</div>
                                    </div>
