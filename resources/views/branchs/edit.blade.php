    ...
    <body class="bg-light">
	 ...
	 @method('PATCH')
        ...
        <div class="text-center">
            <h1 class="py-4"><span class="py-2" style="border-bottom: 2px solid #0174CF; color: #0174CF;">  Edit Branch Information</span></h1>
                    ...
                    <div class="col-12 col-md-10 pl-0 shadow overflow-hidden" style="background-color: #0174CF; border-radius: 30px;">
                        <div class="row">
                            ...
                            <div class="col-9 col-md-10 text-light my-auto px-sm-5 text-left " >
									...
									?>
									<select disabled  class="form-control w-75 m-auto" dir="ltr" id="city"  name="city" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 m-auto py-3">
                                            <div class="m-auto text-left" style="width: 75%;">
                                                <input class="btn px-3 pb-2 pt-0 w-50" type="submit" value="Update" style="background-color: white; color: #0174CF; border-radius: 10px; font-size: x-large;">
                                            </div>
                                        </div>
                                    </div>
                                </form>
