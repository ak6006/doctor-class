...
INSERT INTO `languages` (`id`, `name`, `code`, `cancel`) VALUES
(1, 'عربى', 'ar', 0),
(2, 'English', 'en', 0);
...
(1, 'vision', 'رؤية الموقع', 'vision', 'الموقع', 'site', 1, 0, 0, '2021-05-20 14:10:30'),
(2, 'mision', '‎نظرا للتطور التقني والتكنولوجي الذي تشهده المملكة \r\n‎وحرصا منا على تقديم خدماتنا بافضل الوسائل الموفره للوقت والمال ،والقدرة الدائمة على التحكم .\r\n‎فموقعنا يوفر لك القدرة على التحكم بكافة خدماتنا من خلال عدد من الباقات التي تمنحك حرية الاختيار بين عدد من الباقات التي تستطيع من خلالها تحديد مواعيد وعدد الزيارات التي تحتاجها وايضا امكانية تسجيلك لشركتك وفروعها والتحكم بباقة كل فرع على حدى \r\n‎وايضا من خلال موقع Glass Doctors \r\n‎تستطيع تسجيل :\r\n‎العقار السكني (فيلات -منازل -عمارات) \r\n‎العقار التجاري (شركات -مولات -محلات تجارية -مطاعم -كافيهات -مخابز )\r\n‎عقار صناعي (مصانع -ورش) \r\n\r\n‎الموقع حريص على تقديم افضل الخدمات للعملاء ومتابعة مواعيد الزيارات ومتابعه الفواتير \r\n‎والاجابة على كافة الاستفسارات والعمل الدائم لرفع مستوى الخدمة لننال رضاء العميل \r\n‎من خلال الخدمات المميزة والسرعة والاتقان و الالتزام', 'mision impossible', 'المهام', 'mision', 1, 0, 0, '2021-05-20 16:02:57'),
(3, 'service', 'يبيببليبلبيلبي', 'dfsds fff', 'عنوان الخدمة 1', 'sss 444', 1, 0, 0, '2021-05-20 14:19:07'),
(4, 'company', 'شششششششييييللللنتانةتانتا', 'AHMED SHEHAB dfdffd', 'الشركة', 'company', 1, 0, 0, '2021-05-20 14:34:17'),
(5, 'address', 'الرياض', 'Riyadh ', NULL, NULL, 1, 0, 0, '2021-05-20 16:02:48'),
(6, 'email', 'glasdoctor@galssdoctors.com', 'glasdoctor@galssdoctors.com', NULL, NULL, 1, 0, 0, '2021-05-20 16:02:49'),
(7, 'phone', '٢٢٢٢٢٢٢٤٤٤٤٤٤٤٤٤٤', '+966 444 555 666', NULL, NULL, 1, 0, 0, '2021-05-20 16:02:49'),
(8, 'facebook', NULL, 'https://facebook.com', NULL, NULL, 1, 0, 0, '2021-05-20 14:34:29'),
(9, 'whatsapp', NULL, '+966 444 555 666', NULL, NULL, 1, 0, 0, '2021-05-20 14:34:29'),
(10, 'instgram', NULL, 'https://instgram.com', NULL, NULL, 1, 0, 0, '2021-05-20 14:34:29'),
(11, 'google_map', 'AIzaSyBjCCuQL1P3qR6qti1Hh-eb5WwigF9F_84&callback=initMap&libraries', 'AIzaSyBjCCuQL1P3qR6qti1Hh-eb5WwigF9F_84&callback=initMap&libraries', NULL, NULL, 1, 0, 0, '2021-05-20 16:02:49');
...
(1, 'teamigroup002', 'crew.001.002@gmail.com', '01095109055', '2021-05-18 10:31:59', '$2y$10$INrxYcUYFJfOZygooPSmPeGswKxlSBekXK7hBnD4i/xgb19jNGUIi', 'admin', 'ar', 0, NULL, '2021-04-28 07:21:28', '2021-04-28 07:21:28', 0),
...
(8, 'Team I Group', 'crew.001.003@gmail.com', '01095109055', '2021-05-20 08:48:42', '$2y$10$5OJCt.IxWx.8QzZ0rruhwulI03hsyscylfNbeZ3hkvu1KDapzOjIG', NULL, NULL, 0, NULL, '2021-05-02 10:28:45', '2021-05-02 10:28:45', 0),
