...
Route::resource('bouquetcancelrequest', 'App\Http\Controllers\BouquetCancelRequestController', ['except' => ['create', 'edit']]);
Route::resource('walletaddsuccess', 'App\Http\Controllers\WalletAddSuccessController', ['except' => ['create', 'edit']]);
Route::resource('managesubscriptionsstop', 'App\Http\Controllers\ManageSubscriptionsStopController', ['except' => ['create', 'edit']]);
Route::resource('managesubscriptionsstoped', 'App\Http\Controllers\ManageSubscriptionsStopedController', ['except' => ['create', 'edit']]);

Route::resource('cridt_report', 'App\Http\Controllers\CridtReportController', ['except' => ['create', 'edit']]);
Route::resource('debit_report', 'App\Http\Controllers\DebitReportController', ['except' => ['create', 'edit']]);
